...
<svelte:head>
	<title>Inscription · Cinémag</title>
</svelte:head>
...
>
	<div class="mb-8 flex flex-col items-center gap-2">
		...
		<h1 class="text-2xl font-semibold tracking-tight text-zinc-50">Créer un compte</h1>
		<p class="text-sm text-zinc-400">Rejoins la communauté Cinémag</p>
	</div>

	{#if form?.message}
		<div
			class="mb-6 rounded-lg border px-4 py-3 text-sm {form?.success
	...
	<p class="mt-6 text-center text-sm text-zinc-500">
		Déjà inscrit ?
		<a href="/auth/login" class="font-medium text-emerald-400 hover:text-emerald-300">
			Se connecter
		</a>
	</p>
</div>
